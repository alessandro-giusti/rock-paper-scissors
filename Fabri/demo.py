...
special_input.append("IMAGES/rock_perfect2.jpg")
special_input.append("IMAGES/paper_perfect2.jpg")
special_input.append("IMAGES/scissors_perfect2.jpg")
special_input.append("IMAGES/rock_perfect.jpg")
special_input.append("IMAGES/paper_perfect.jpg")
special_input.append("IMAGES/scissors_perfect.jpg")
output=[]*3
...
#    out.write(image)
    ...
    if key & 0xFF == ord('4'):
        video, inputtino, inputtinob, inputtinod=False, special_input2[3], special_input3[3], special_input4[3]
    if key & 0xFF == ord('5'):
        video, inputtino, inputtinob, inputtinod=False, special_input2[4], special_input3[4], special_input4[4]
    if key & 0xFF == ord('6'):
        video, inputtino, inputtinob, inputtinod=False, special_input2[5], special_input3[5], special_input4[5]
    if key & 0xFF == ord('7'):
        video, inputtino, inputtinob, inputtinod=False, special_input2[6], special_input3[6], special_input4[6]
    if key & 0xFF == ord('8'):
        video, inputtino, inputtinob, inputtinod=False, special_input2[7], special_input3[7], special_input4[7]
    if key & 0xFF == ord('9'):
        video, inputtino, inputtinob, inputtinod=False, special_input2[8], special_input3[8], special_input4[8]

...
print("hello")
a=np.max(model.predict([X]))
print(a)
model.save('simplex.model')
...
###    input1=np.random.random((1, 64, 64, 3))
...
##        plt.imshow(np.clip(grads_value[0]*step, 0, 1))
##        plt.show()
...
##    for i in range(1):
##        print(i)
##        map_image=create_input(1, 1)
##        scipy.misc.imsave('IMAGES/f%d.jpg' %(i+1), map_image)
##
##
##def visualization3():
